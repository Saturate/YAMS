...
- Observation granularity — MCP tools for drilling into individual observations with citation IDs. Timeline browsing to see chronological context around a specific observation. Individual observation fetch by ID for precise context retrieval. Enables workflows like "show me exactly what was decided on line 42 of that refactor session."
