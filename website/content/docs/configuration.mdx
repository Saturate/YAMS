...
| `HUSK_TTL_DEFAULT_PROJECT` | `ttl_default_project` | _(none)_ | Project memory TTL (forever by default) |
| `HUSK_TTL_DEFAULT_WORKSPACE` | `ttl_default_workspace` | _(none)_ | Workspace memory TTL (forever by default) |
